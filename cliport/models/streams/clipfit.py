...
class clipfit(conceptfusion):
    ...
    def similarity_map(self, input_color, input_depth, l1, l2, name):
        ...
        # 生成原图
        plt.imshow(out)
        plt.savefig("/home/a/acw799/cliport/cliport/visualization/boxes_image.png")
        # plt.figure(figsize=(20, 20))
        plt.imshow(img)
        show_anns(masks)
        plt.savefig("cliport/visualization/boxes_masks.png") 
        ...
        # 生成相似度图
        plt.imshow(sim1)
        plt.savefig("/home/a/acw799/cliport/cliport/visualization/boxes_sim1.png")
        plt.imshow(sim2)
        plt.savefig("/home/a/acw799/cliport/cliport/visualization/boxes_sim2.png")
